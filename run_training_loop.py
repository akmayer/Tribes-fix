...
FASTAPI_PORT = 8000
PARALLEL_JOBS = max(1, env_int("TRIBES_PARALLEL_JOBS", 5))
FASTAPI_WORKERS = max(1, env_int("TRIBES_FASTAPI_WORKERS", 5))
...
CAPTURE_RATE_LOG_INTERVAL_SECONDS = max(1, env_int("TRIBES_CAPTURE_RATE_LOG_INTERVAL_SECONDS", 20))
